...
def tile_images(img_nhwc):
    ...
    Inputs
    ---------------
        img_nhwc, list_or_array of images, ndim=4
        once turned into array
            n = batch index,
            h = height,
            w = width,
            c = channel
    ...
    Returns
    ----------------
        bitimg_HWc, ndarray with ndim=3
    """
    ...
    img_HWhwc = img_HWhwc.transpose(0, 2, 1, 3, 4)
    img_Hh_Ww_c = img_HWhwc.reshape(H*h, W*w, c)

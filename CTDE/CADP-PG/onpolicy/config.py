...
def get_config():
    ...
    parser.add_argument(
        ...
        action='store_false',
        default=True,
        help="[for wandb usage], will log data to wandb server. or else will use tensorboard to log data.",
    )
    ...
    parser.add_argument(
        ...
        help="by default, do not render the env during training. \
            ...
            has internal render process which is not controlled by this hyperparam."
    )
    parser.add_argument(
        "--render_episodes", 
        type=int, 
